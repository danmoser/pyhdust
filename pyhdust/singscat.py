...
def blobs_coords(db=2, rb=1.0 / 3, res=3, Req=1.0, phi0=0, beta=0.0):
    """
...
def disk_coords(dd=2, rd=1.0 / 3, res=11.0, Req=1.0, beta=0.0, phi0=0.0):
...
def blobs_cicle(phi_ar, irad, Req=_phc.Rsun.cgs, rb=1 / 3.0, db=2.0, bres=3, nb=8e11):
...
def calc_phase(MJDar, period, MJD0=0.0):
    """Calc phase [0,1)"""
