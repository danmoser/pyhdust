...
def makeInpJob(modn='01', nodes=512, simulations=['SED'], basesims=[''],
    ...
    each source star.
        ...
        docases = [1,2,3]
        #1 = step1  <> Gera inp+job so' para mod#/mod#.txt
        ...
        simulations = ['sed','brg_M','halpha_M','uv','j','h','k','l','m','n',
         'q1','q2']
        simulations = ['SED','Ha']
        ...
        srcNf=[False, True]  # `False` = for continuum bands; `True` for 
            # specific simulation files for line profiles or variable photon 
            # numbers SED.
        ###stop edition here
    """
    def isFloat(x):
